...
export default {
    ...
    methods: {
        fetchSchedule(id) {
            axios.get(`/schedule/fetch_pickup_schedule_details/${id}`).then(({data}) => {
                this.scheduleForm.fill(data);
                // this.scheduleForm.time_start = data.time_start;
                // this.scheduleForm.time_end = data.time_end;
            });
        },
        checkScheduleForm() {
            ...
            if (this.scheduleForm.time_start === null || this.scheduleForm.time_start === null) {
                ...
                axios.get('/schedule/server_date').then((response) => {
                    ...
                    axios.put('/schedule/update_pickup_schedule_details', this.scheduleForm).then(({ data, status }) => {
                        ...
                        Swal.fire({
                            ...
                            $("div#modal-edit-schedule").modal('hide');
                        });
                    });
                });
            }
