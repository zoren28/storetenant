        ...
        <div class="page-title-box">
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item active">Import Product Pictures</li>
            </ol>
          </div>
          <h4 class="page-title">Import Product Pictures</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
...
<script>
Dropzone.options.productPicturesUpload = {
  paramName: 'file', // The name that will be used to transfer the file
  url: '/import/product_pictures',
  timeout: 100000000,
  acceptedFiles: '.zip',
  init: function() {
    ...
    this.on('success', function(file) {
      Swal.fire({
        ...
        text: 'Product pictures have been uploaded successfully',
        showConfirmButton: false,
        timer: 1000,
        allowOutsideClick: false
      }).then(() => {
