...
<template>
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form
        @submit.prevent="selectProductForm"
        method="post"
...
<script>
export default {
  name: 'SelectProductChoiceComponent',
  ...
  methods: {
    ...
    selectProductForm() {
      ...
      axios
        .post('/product/add_choice_sides', this.params)
        .then(({ data, status }) => {
          const { message } = data
          ...
          Swal.fire({
            ...
            this.$parent.fetchProductList(this.product_choice, 1)
          })
        })
    }
  },
  watch: {
    fd_products: function() {
      this.loadTable()
    }
  }
}
