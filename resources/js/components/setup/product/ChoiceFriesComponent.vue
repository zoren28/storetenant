                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Choice of Fries</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Choice of Fries</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
...
<script>
import SelectProduct from "./SelectFriesComponent.vue";
...
export default {
    ...
    methods: {
        async fetchProductList(filter) {
            ...
            const response = await axios.get(`/product/fetch_fries_list/${filter}`);
        ...
        async selectProduct() {
            ...
            const {data} = await axios.get('/product/fetch_fries_list/0');
        ...
        removeProduct(product_id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.put('/product/remove_choice_fries', this.params).then(({ data, status }) => {
