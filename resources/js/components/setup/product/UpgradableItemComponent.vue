                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Upgradable Item</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Upgradable Item</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
...
<script>
import SelectProduct from "./SelectUpgradableItemComponent.vue";
...
export default {
    ...
    methods: {
        async fetchProductList(filter) {
            ...
            const response = await axios.get(`/product/fetch_addon_dessert_list/${filter}`);
        ...
        async selectProduct() {
            ...
            const {data} = await axios.get('/product/fetch_addon_dessert_list/0');
        ...
        removeProduct(product_id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.put('/product/remove_addon_dessert', this.params).then(({ data, status }) => {
