          ...
          <div class="card-body">
              ...
              <div class="col-md-10">
                <div class="form-inline float-right">
                  ...
                  <button
                    ...
                    @click="fetch_transaction_report"
                    :disabled="
                      date_from === null ||
                        date_to === null ||
                        date_to < date_from
            ...
            <div class="row">
              ...
              <div class=" col-md-12 text-center pb-2">
                ...
                <h4 class="mb-2">Transaction Summary Report</h4>
                <p
...
export default {
  ...
  methods: {
    async fetch_transaction_report() {
      const { data } = await axios.get(
        `/report/fetch_transaction_report/${this.date_from}/${this.date_to}`
      )
