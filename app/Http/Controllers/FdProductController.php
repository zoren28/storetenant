...
class FdProductController extends Controller
{
    ...
    public function import_product_masterfile(Request $request)
    {
        ...
        $path   = '../storetenant.alturush.com/storage/temp/' . $filename;
    ...
    public function import_category_pictures(Request $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $target_dir = '../storetenant.alturush.com/storage/uploads/fd_categories/';
                        ...
                        while (($file = readdir($dh)) !== false) {
                            ...
                            if ($category !== '') {
                                ...
                                if (!empty($fd_category) && $fd_category->image != '') {
                                    ...
                                    unlink('../storetenant.alturush.com/storage/' . $fd_category->image);
    ...
    public function import_product_pictures(Request $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $target_dir = '../storetenant.alturush.com/storage/uploads/fd_products/';
                        ...
                        while (($file = readdir($dh)) !== false) {
                            ...
                            if ($product !== '') {
                                ...
                                if (!empty($fd_product) && $fd_product->image != '') {
                                    ...
                                    unlink('../storetenant.alturush.com/storage/' . $fd_product->image);
